...
__start = ['---XX---------', '---XX---S-----']
__end = ['X---X---------', '--------------', '--------------', 'X-------------', 'X-------------', 'X-X-----------', 'X-XX----------', 'X-XX----------', 'XXXXXX--------', 'XXXXXXX-------', 'XXXXXXXX------', 'XXXXXXXXX-----', 'XXXXXXXXX-----', 'XXXXXXXXX-----', 'X-------------', 'X-------------', 'X-------------', 'X-------------', 'X-------------', 'X-------------', 'X-------------', 'X-------------']

assert gram.sequence_is_possible(__start)
assert gram.sequence_is_possible(__end)

link = generate_link_bfs(gram, __start, __end, 1, agent=Mario.get_percent_playable)
